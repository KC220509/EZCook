...
public class f_ingredient_detail {
    ...
    public f_ingredient_detail(String img_ingredient, String name_ingredient, String mass_ingredient) {
        this.img_ingredient = img_ingredient;
        this.name_ingredient = name_ingredient;
        this.mass_ingredient = mass_ingredient;
    }

    public String getImg_ingredient() {
        return img_ingredient;
    }

    public void setImg_ingredient(String img_ingredient) {
        this.img_ingredient = img_ingredient;
    }
