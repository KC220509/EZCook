...
public class category_foodnew_adapter extends RecyclerView.Adapter<category_foodnew_adapter.viewholder_foodnew> {
    public List<category_foodnew_model> categoryFoodnewModels;
    public void setData(List<category_foodnew_model> categoryfoodnewModels){
    ...
    public viewholder_foodnew onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view_foodnew = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_category_foodnew, parent,false);
        return new viewholder_foodnew(view_foodnew);
    }

    @Override
    public void onBindViewHolder(@NonNull viewholder_foodnew holder, int position) {
        category_foodnew_model categoryFoodnewModel = categoryFoodnewModels.get(position);
